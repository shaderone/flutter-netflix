...
mixin _$FastLaughState {
  List<DownloadsModal> get profileList => throw _privateConstructorUsedError;
...
abstract class $FastLaughStateCopyWith<$Res> {
  ...
  $Res call({List<DownloadsModal> profileList, bool isLoading, bool isError});
}
...
class _$FastLaughStateCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      profileList: profileList == freezed
          ? _value.profileList
...
class _$_Initial implements _Initial {
  const _$_Initial(
      {required final List<DownloadsModal> profileList,
      required this.isLoading,
      required this.isError})
      : _profileList = profileList;

  final List<DownloadsModal> _profileList;
  @override
  List<DownloadsModal> get profileList {
  ...
  @override
  String toString() {
    return 'FastLaughState(profileList: $profileList, isLoading: $isLoading, isError: $isError)';
  }
